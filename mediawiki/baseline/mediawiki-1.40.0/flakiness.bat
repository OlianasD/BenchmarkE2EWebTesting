...
for /L %%i in (1,1,%n%) do (
    ...
    mkdir "..\..\results\post-fix\mediawiki\java21-selenium314159-chrome137-headlesnew\%%i"
    xcopy /E /Y "target\surefire-reports\*" "..\..\results\post-fix\mediawiki\java21-selenium314159-chrome137-headlesnew\%%i\"
