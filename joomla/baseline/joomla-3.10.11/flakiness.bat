...
for /L %%i in (1,1,%n%) do (
    ...
    mkdir "..\..\results\post-fix\joomla-3.10.11\java21-selenium314159-chrome137-headlessnew\%%i"
    xcopy /E /Y "target\surefire-reports\*" "..\..\results\post-fix\joomla-3.10.11\java21-selenium314159-chrome137-headlessnew\%%i\"
