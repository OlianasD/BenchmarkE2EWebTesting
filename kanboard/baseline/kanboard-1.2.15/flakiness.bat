...
for /L %%i in (1,1,%n%) do (
    ...
    mkdir "..\..\..\..\flakycheck\kanboard-strongpsw\java21-selenium314159-chrome137-headlessnew\%%i"
    xcopy /E /Y "target\surefire-reports\*" "..\..\..\..\flakycheck\kanboard-strongpsw\java21-selenium314159-chrome137-headlessnew\%%i\"
