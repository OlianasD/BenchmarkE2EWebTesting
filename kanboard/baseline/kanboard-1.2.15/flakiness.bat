...
for /L %%i in (1,1,%n%) do (
    ...
    mkdir "..\..\..\..\flakycheck\kanboard\java21-selenium314159-chrome138-headlessnew\%%i"
    xcopy /E /Y "target\surefire-reports\*" "..\..\..\..\flakycheck\kanboard\java21-selenium314159-chrome138-headlessnew\%%i\"
