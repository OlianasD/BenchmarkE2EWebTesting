...
for /L %%i in (1,1,%n%) do (
    ...
    mkdir "..\..\..\..\flakycheck\bludit-2.3.4\java21-selenium314159-chrome122-headlesnew\%%i"
    xcopy /E /Y "target\surefire-reports\*" "..\..\..\..\flakycheck\bludit-2.3.4\java21-selenium314159-chrome122-headlesnew\%%i\"
