...
for /L %%i in (1,1,%n%) do (
    ...
    mkdir "..\..\..\..\flakycheck\mantisbt-2.25.4\java21-selenium314159-chrome137-headlessnew\%%i"
    xcopy /E /Y "target\surefire-reports\*" "..\..\..\..\flakycheck\mantisbt-2.25.4\java21-selenium314159-chrome137-headlessnew\%%i\"
