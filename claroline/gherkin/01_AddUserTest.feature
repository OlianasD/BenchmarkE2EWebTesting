Scenario: Adds a user to the system
	Given the user is on the home page (/claroline11110/index.php)
		...
		And enters "n0tl34k3dy3t" in the "Password" field
		And enters "n0tl34k3dy3t" in the "Password (Confirmation)" field
		And clicks the "Follow courses (student)" radio button
		And clicks the "Ok" button
	#"sucessfully" with only one "c", there is a typo in Claroline
	Then "The new user has been sucessfully created" is shown on the page
