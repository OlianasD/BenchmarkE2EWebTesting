...
for /L %%i in (1,1,%n%) do (
    ...
    mkdir "..\..\..\..\flakycheck\prestashop-1.6.1.23\java21-selenium435-chrome139-headlessnew\%%i"
    xcopy /E /Y "target\surefire-reports\*" "..\..\..\..\flakycheck\prestashop-1.6.1.23\java21-selenium435-chrome139-headlessnew\%%i\"
